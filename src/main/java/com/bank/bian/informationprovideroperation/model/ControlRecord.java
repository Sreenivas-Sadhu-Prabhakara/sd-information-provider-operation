package com.bank.bian.informationprovideroperation.model;
...
/**
 * The BIAN control record for this service domain: "Information Feed Operating Session".
 *
 ...
 * to its asset type (Information Feed). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Information Feed Operating Session";
